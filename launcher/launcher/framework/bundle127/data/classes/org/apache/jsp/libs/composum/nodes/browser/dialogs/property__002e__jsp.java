...
public final class property__002e__jsp extends org.apache.sling.scripting.jsp.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      // /libs/composum/nodes/browser/dialogs/property.jsp(5,0) name = id type = java.lang.String reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_cpn_component_0.setId("browser");
      // /libs/composum/nodes/browser/dialogs/property.jsp(5,0) name = type type = java.lang.String reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_cpn_component_0.setType("com.composum.sling.nodes.browser.Browser");
      // /libs/composum/nodes/browser/dialogs/property.jsp(5,0) name = scope type = java.lang.String reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_cpn_form_0(javax.servlet.jsp.tagext.JspTag _jspx_th_cpn_component_0, PageContext _jspx_page_context)
    ...
    // /libs/composum/nodes/browser/dialogs/property.jsp(11,8) name = classes type = java.lang.String reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_cpn_form_0.setClasses("widget-form default");
    // /libs/composum/nodes/browser/dialogs/property.jsp(11,8) name = enctype type = java.lang.String reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_cpn_form_0.setEnctype("multipart/form-data");
    // /libs/composum/nodes/browser/dialogs/property.jsp(11,8) name = action type = java.lang.String reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_cpn_form_0.setAction("/bin/cpm/nodes/property.bin");
    ...
    if (_jspx_eval_cpn_form_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      ...
      do {
        ...
        out.write("                <div class=\"form-group subtype\">\n");
        out.write("                  <label class=\"control-label\">Subtype</label>\n");
        out.write("                  <select name=\"subtype\" class=\"subtype-select widget select-widget form-control\">\n");
        ...
        out.write("            </div>\n");
        out.write("            ");
        if (_jspx_meth_sling_call_0(_jspx_th_cpn_form_0, _jspx_page_context))
          return true;
        out.write("\n");
        out.write("          </div>\n");
        out.write("\n");
  ...
  private boolean _jspx_meth_sling_call_0(javax.servlet.jsp.tagext.JspTag _jspx_th_cpn_form_0, PageContext _jspx_page_context)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  sling:call
    ...
    _jspx_th_sling_call_0.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_cpn_form_0);
    // /libs/composum/nodes/browser/dialogs/property.jsp(56,12) name = script type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_sling_call_0.setScript((java.lang.String) org.apache.sling.scripting.jsp.jasper.runtime.PageContextImpl.proprietaryEvaluate("${composumBase}composum/nodes/browser/dialogs/property-value.jsp", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
