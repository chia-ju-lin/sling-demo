...
public final class navbar__002e__jsp extends org.apache.sling.scripting.jsp.jasper.runtime.HttpJspBase
...
static {
  ...
  _jspx_fnmap_0.mapFunction("cpn:url", com.composum.sling.cpnl.CpnlElFunctions.class, "url", new Class[] {org.apache.sling.api.SlingHttpServletRequest.class, java.lang.String.class});
  _jspx_fnmap_0.mapFunction("cpn:cpm", com.composum.sling.cpnl.CpnlElFunctions.class, "cpm", new Class[] {java.lang.String.class});
  _jspx_fnmap_1= org.apache.sling.scripting.jsp.jasper.runtime.ProtectedFunctionMapper.getMapForFunction("cpn:i18n", com.composum.sling.cpnl.CpnlElFunctions.class, "i18n", new Class[] {org.apache.sling.api.SlingHttpServletRequest.class, java.lang.String.class});
}
  ...
  private org.apache.sling.scripting.jsp.jasper.runtime.TagHandlerPool _jspx_tagPool_cpn_image_src_alt_nobody;
  ...
  public void _jspInit() {
    ...
    _jspx_tagPool_cpn_image_src_alt_nobody = org.apache.sling.scripting.jsp.jasper.runtime.TagHandlerPool.getTagHandlerPool(getServletConfig());
  ...
  public void _jspDestroy() {
    ...
    _jspx_tagPool_cpn_image_src_alt_nobody.release();
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      // /libs/composum/nodes/console/components/navbar/navbar.jsp(6,0) name = id type = java.lang.String reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_cpn_component_0.setId("console");
      // /libs/composum/nodes/console/components/navbar/navbar.jsp(6,0) name = type type = java.lang.String reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      if (_jspx_eval_cpn_component_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          out.write("                <a href=\"");
          out.write((java.lang.String) org.apache.sling.scripting.jsp.jasper.runtime.PageContextImpl.proprietaryEvaluate("${cpn:url(slingRequest,cpn:cpm('composum/nodes/console/content'))}", java.lang.String.class, (PageContext)_jspx_page_context, _jspx_fnmap_0, false));
          out.write("\">\n");
          out.write("                    ");
          if (_jspx_meth_cpn_image_0(_jspx_th_cpn_component_0, _jspx_page_context))
            return;
          out.write("\n");
          out.write("                </a>\n");
          out.write("            </div>\n");
          ...
          out.write((java.lang.String) org.apache.sling.scripting.jsp.jasper.runtime.PageContextImpl.proprietaryEvaluate("${console.currentUser}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
          out.write("</em></a>\n");
          out.write("                    <a class=\"system-health-monitor delimiter\" tabindex=\"0\" role=\"button\"\n");
          out.write("                       title=\"");
          out.write((java.lang.String) org.apache.sling.scripting.jsp.jasper.runtime.PageContextImpl.proprietaryEvaluate("${cpn:i18n(slingRequest,'System Health')}", java.lang.String.class, (PageContext)_jspx_page_context, _jspx_fnmap_1, false));
          out.write("\" data-trigger=\"focus\"\n");
          out.write("                       data-container=\"body\" data-toggle=\"popover\" data-placement=\"bottom\"\n");
          out.write("                       data-content=\"Vivamus sagittis lacus vel augue laoreet rutrum faucibus.\"><span></span>\n");
          out.write("                        <div class=\"system-health-popover hidden\">\n");
          out.write("                            ");
          ...
          out.write("                        </div>\n");
          out.write("                    </a>\n");
          out.write("                    <a class=\"nav-workspace-menu\" data-toggle-x=\"dropdown\"\n");
          out.write("                       title=\"System configuration...\"><em>");
          out.write((java.lang.String) org.apache.sling.scripting.jsp.jasper.runtime.PageContextImpl.proprietaryEvaluate("${console.workspaceName}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
          out.write("</em></a>\n");
          out.write("                        ");
          out.write("\n");
          out.write("                </li>\n");
  ...
  private boolean _jspx_meth_cpn_image_0(javax.servlet.jsp.tagext.JspTag _jspx_th_cpn_component_0, PageContext _jspx_page_context)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  cpn:image
    com.composum.sling.cpnl.ImageTag _jspx_th_cpn_image_0 = (com.composum.sling.cpnl.ImageTag) _jspx_tagPool_cpn_image_src_alt_nobody.get(com.composum.sling.cpnl.ImageTag.class);
    _jspx_th_cpn_image_0.setPageContext(_jspx_page_context);
    _jspx_th_cpn_image_0.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_cpn_component_0);
    // /libs/composum/nodes/console/components/navbar/navbar.jsp(16,20) name = src type = java.lang.String reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_cpn_image_0.setSrc((java.lang.String) org.apache.sling.scripting.jsp.jasper.runtime.PageContextImpl.proprietaryEvaluate("${composumBase}composum/nodes/console/page/images/composum-nodes-logo-on-black.png", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
    // /libs/composum/nodes/console/components/navbar/navbar.jsp(16,20) name = alt type = java.lang.String reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_cpn_image_0.setAlt("");
    int _jspx_eval_cpn_image_0 = _jspx_th_cpn_image_0.doStartTag();
    if (_jspx_th_cpn_image_0.doEndTag() == javax.servlet.jsp.tagext.Tag.SKIP_PAGE) {
      _jspx_tagPool_cpn_image_src_alt_nobody.reuse(_jspx_th_cpn_image_0);
      return true;
    }
    _jspx_tagPool_cpn_image_src_alt_nobody.reuse(_jspx_th_cpn_image_0);
    return false;
  ...
  private boolean _jspx_meth_sling_call_0(javax.servlet.jsp.tagext.JspTag _jspx_th_cpn_component_0, PageContext _jspx_page_context)
    ...
    // /libs/composum/nodes/console/components/navbar/navbar.jsp(21,12) name = script type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_sling_call_0.setScript("consoles.jsp");
  ...
  private boolean _jspx_meth_c_if_0(javax.servlet.jsp.tagext.JspTag _jspx_th_cpn_component_0, PageContext _jspx_page_context)
    ...
    // /libs/composum/nodes/console/components/navbar/navbar.jsp(23,16) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_if_0.setTest(((java.lang.Boolean) org.apache.sling.scripting.jsp.jasper.runtime.PageContextImpl.proprietaryEvaluate("${console.supportsPermissions}", java.lang.Boolean.class, (PageContext)_jspx_page_context, null, false)).booleanValue());
    int _jspx_eval_c_if_0 = _jspx_th_c_if_0.doStartTag();
    if (_jspx_eval_c_if_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        out.write("\n");
        out.write("                    <li>\n");
        out.write("                        <button type=\"button\" class=\"nav-permissions-status btn btn-default\"\n");
        out.write("                                data-user=\"");
        out.write((java.lang.String) org.apache.sling.scripting.jsp.jasper.runtime.PageContextImpl.proprietaryEvaluate("${console.userPermission}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
        out.write("\" data-system=\"");
        out.write((java.lang.String) org.apache.sling.scripting.jsp.jasper.runtime.PageContextImpl.proprietaryEvaluate("${console.systemPermission}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
        out.write("\"\n");
        out.write("                                title=\"\"><i class=\"fa\"></i></button>\n");
        out.write("                    </li>\n");
        out.write("                ");
  ...
  private boolean _jspx_meth_sling_include_0(javax.servlet.jsp.tagext.JspTag _jspx_th_cpn_component_0, PageContext _jspx_page_context)
    ...
    // /libs/composum/nodes/console/components/navbar/navbar.jsp(37,28) name = resourceType type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_sling_include_0.setResourceType("composum/nodes/commons/components/system");
