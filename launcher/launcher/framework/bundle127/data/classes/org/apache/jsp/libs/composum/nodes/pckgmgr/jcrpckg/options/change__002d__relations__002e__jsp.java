...
public final class change__002d__relations__002e__jsp extends org.apache.sling.scripting.jsp.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      // /libs/composum/nodes/pckgmgr/jcrpckg/options/change-relations.jsp(6,0) name = id type = java.lang.String reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_cpn_component_0.setId("pckgmgr");
      // /libs/composum/nodes/pckgmgr/jcrpckg/options/change-relations.jsp(6,0) name = type type = java.lang.String reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_cpn_component_0.setType("com.composum.sling.core.pckgmgr.view.PackageManagerBean");
      // /libs/composum/nodes/pckgmgr/jcrpckg/options/change-relations.jsp(6,0) name = scope type = java.lang.String reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      if (_jspx_eval_cpn_component_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          out.write("\n");
          out.write("    <div id=\"pckg-relations-change-dialog\" class=\"change relations dialog modal fade\" role=\"dialog\" aria-hidden=\"true\">\n");
  ...
  private boolean _jspx_meth_cpn_form_0(javax.servlet.jsp.tagext.JspTag _jspx_th_cpn_component_0, PageContext _jspx_page_context)
    ...
    // /libs/composum/nodes/pckgmgr/jcrpckg/options/change-relations.jsp(11,16) name = classes type = java.lang.String reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_cpn_form_0.setClasses("widget-form");
    // /libs/composum/nodes/pckgmgr/jcrpckg/options/change-relations.jsp(11,16) name = method type = java.lang.String reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_cpn_form_0.setMethod("POST");
    // /libs/composum/nodes/pckgmgr/jcrpckg/options/change-relations.jsp(11,16) name = action type = java.lang.String reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    ...
    if (_jspx_eval_cpn_form_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      ...
      do {
        ...
        out.write("                        <h4 class=\"modal-title\">Change...</h4>\n");
        out.write("                    </div>\n");
        ...
        out.write("\n");
        out.write("                        <div class=\"relations form-group widget multi-form-widget\">\n");
        out.write("                            <div class=\"multi-form-content\">\n");
        out.write("                                <div class=\"multi-form-item\">\n");
        out.write("                                    <input class=\"relation widget text-field-widget form-control\"\n");
        out.write("                                           type=\"text\" placeholder=\"group:name:version\"/>\n");
        out.write("                                </div>\n");
        out.write("                            </div>\n");
        out.write("                        </div>\n");
        out.write("                    </div>\n");
