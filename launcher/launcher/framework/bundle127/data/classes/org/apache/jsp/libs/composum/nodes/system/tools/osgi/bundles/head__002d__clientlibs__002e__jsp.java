...
public final class head__002d__clientlibs__002e__jsp extends org.apache.sling.scripting.jsp.jasper.runtime.HttpJspBase
...
static {
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write((java.lang.String) org.apache.sling.scripting.jsp.jasper.runtime.PageContextImpl.proprietaryEvaluate("${cpn:url(slingRequest,cpn:cpm('composum/nodes/system/tools/osgi/bundles/css/bundles.css'))}", java.lang.String.class, (PageContext)_jspx_page_context, _jspx_fnmap_0, false));
      out.write('"');
      out.write('>');
      out.write('\n');
    } catch (Throwable t) {
  ...
  private boolean _jspx_meth_cpn_clientlib_0(PageContext _jspx_page_context)
    ...
    // /libs/composum/nodes/system/tools/osgi/bundles/head-clientlibs.jsp(5,0) name = type type = java.lang.String reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_cpn_clientlib_0.setType("link");
    // /libs/composum/nodes/system/tools/osgi/bundles/head-clientlibs.jsp(5,0) name = category type = java.lang.String reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_cpn_clientlib_0.setCategory("composum.nodes.console.tools");
  ...
  private boolean _jspx_meth_cpn_clientlib_1(PageContext _jspx_page_context)
    ...
    // /libs/composum/nodes/system/tools/osgi/bundles/head-clientlibs.jsp(6,0) name = type type = java.lang.String reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_cpn_clientlib_1.setType("css");
    // /libs/composum/nodes/system/tools/osgi/bundles/head-clientlibs.jsp(6,0) name = category type = java.lang.String reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_cpn_clientlib_1.setCategory("composum.nodes.console.tools");
