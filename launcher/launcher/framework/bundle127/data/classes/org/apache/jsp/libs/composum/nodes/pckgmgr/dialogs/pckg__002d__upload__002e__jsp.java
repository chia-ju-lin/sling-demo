...
public final class pckg__002d__upload__002e__jsp extends org.apache.sling.scripting.jsp.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      // /libs/composum/nodes/pckgmgr/dialogs/pckg-upload.jsp(6,0) name = id type = java.lang.String reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_cpn_component_0.setId("browser");
      // /libs/composum/nodes/pckgmgr/dialogs/pckg-upload.jsp(6,0) name = type type = java.lang.String reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_cpn_component_0.setType("com.composum.sling.nodes.browser.Browser");
      // /libs/composum/nodes/pckgmgr/dialogs/pckg-upload.jsp(6,0) name = scope type = java.lang.String reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      if (_jspx_eval_cpn_component_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          out.write("\n");
          out.write("  <div id=\"pckg-upload-dialog\" class=\"dialog modal fade\" role=\"dialog\" aria-hidden=\"true\">\n");
  ...
  private boolean _jspx_meth_cpn_form_0(javax.servlet.jsp.tagext.JspTag _jspx_th_cpn_component_0, PageContext _jspx_page_context)
    ...
    // /libs/composum/nodes/pckgmgr/dialogs/pckg-upload.jsp(11,8) name = classes type = java.lang.String reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_cpn_form_0.setClasses("widget-form");
    // /libs/composum/nodes/pckgmgr/dialogs/pckg-upload.jsp(11,8) name = enctype type = java.lang.String reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_cpn_form_0.setEnctype("multipart/form-data");
    // /libs/composum/nodes/pckgmgr/dialogs/pckg-upload.jsp(11,8) name = action type = java.lang.String reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_cpn_form_0.setAction("/bin/cpm/package.upload.json");
    ...
    if (_jspx_eval_cpn_form_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      ...
      do {
        ...
        out.write("            <h4 class=\"modal-title\">Upload Package</h4>\n");
        out.write("          </div>\n");
        ...
        out.write("              <label class=\"control-label\">Package File</label>\n");
        out.write("              <input name=\"file\" class=\"widget file-upload-widget form-control\" type=\"file\"\n");
        out.write("                     data-options=\"hidePreview\"/>\n");
        out.write("            </div>\n");
        out.write("            <div class=\"form-group\">\n");
        out.write("              <label class=\"control-label\">Force Upload</label>\n");
        out.write("              <input name=\"force\" class=\"widget checkbox-widget form-control\" type=\"checkbox\"/>\n");
        out.write("            </div>\n");
        out.write("          </div>\n");
        out.write("\n");
        ...
        out.write("            <button type=\"submit\" class=\"btn btn-primary upload\">Upload</button>\n");
        out.write("          </div>\n");
        out.write("        ");
