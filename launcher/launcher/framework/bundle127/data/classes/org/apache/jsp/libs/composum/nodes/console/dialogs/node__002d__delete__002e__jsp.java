...
public final class node__002d__delete__002e__jsp extends org.apache.sling.scripting.jsp.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      // /libs/composum/nodes/console/dialogs/node-delete.jsp(6,0) name = id type = java.lang.String reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_cpn_component_0.setId("browser");
      // /libs/composum/nodes/console/dialogs/node-delete.jsp(6,0) name = type type = java.lang.String reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_cpn_component_0.setType("com.composum.sling.nodes.browser.Browser");
      // /libs/composum/nodes/console/dialogs/node-delete.jsp(6,0) name = scope type = java.lang.String reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      if (_jspx_eval_cpn_component_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          out.write("\n");
          out.write("    <div id=\"node-delete-dialog\" class=\"dialog modal fade\" role=\"dialog\" aria-hidden=\"true\">\n");
          ...
          out.write("                        <h4 class=\"modal-title\">Delete Node</h4>\n");
          out.write("                    </div>\n");
          ...
          out.write("                            <label class=\"control-label\">Node Path for Deletion</label>\n");
          out.write("                            <div class=\"path input-group widget path-widget\" data-rules=\"mandatory\"\n");
          out.write("                                 data-pattern=\"/^\\//\">\n");
          ...
          out.write("                            <label><input class=\"smart\" type=\"checkbox\" value=\"\">Don't ask up to the next page\n");
          out.write("                                reload.</label>\n");
          out.write("                        </div>\n");
          out.write("                    </div>\n");
          out.write("\n");
          ...
          out.write("                        <button type=\"submit\" class=\"btn btn-danger delete\">Delete</button>\n");
          out.write("                    </div>\n");
          out.write("                </form>\n");
          out.write("            </div>\n");
          out.write("        </div>\n");
