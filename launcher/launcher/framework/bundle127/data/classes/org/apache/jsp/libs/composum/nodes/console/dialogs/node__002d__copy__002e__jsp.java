...
public final class node__002d__copy__002e__jsp extends org.apache.sling.scripting.jsp.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      // /libs/composum/nodes/console/dialogs/node-copy.jsp(6,0) name = id type = java.lang.String reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_cpn_component_0.setId("browser");
      // /libs/composum/nodes/console/dialogs/node-copy.jsp(6,0) name = type type = java.lang.String reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_cpn_component_0.setType("com.composum.sling.nodes.browser.Browser");
      // /libs/composum/nodes/console/dialogs/node-copy.jsp(6,0) name = scope type = java.lang.String reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      if (_jspx_eval_cpn_component_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          out.write("\n");
          out.write("  <div id=\"node-copy-dialog\" class=\"dialog modal fade\" role=\"dialog\" aria-hidden=\"true\">\n");
          ...
          out.write("            <h4 class=\"modal-title\">Copy Node</h4>\n");
          out.write("          </div>\n");
          ...
          out.write("            <input name=\"node\" type=\"hidden\">\n");
          out.write("\n");
          out.write("            <div class=\"form-group\">\n");
          out.write("              <label class=\"control-label\">New name</label>\n");
          out.write("              <input name=\"newname\" class=\"widget text-field-widget form-control\" type=\"text\" placeholder=\"enter node name\" data-rules=\"mandatory\" autofocus>\n");
          out.write("            </div>\n");
          out.write("\n");
          out.write("            <div class=\"form-group\">\n");
          out.write("              <label class=\"control-label\">Into path <span>(parent)</span></label>\n");
          ...
          out.write("            <button type=\"submit\" class=\"btn btn-primary copy\">Copy</button>\n");
          out.write("          </div>\n");
          out.write("        </form>\n");
          out.write("      </div>\n");
          out.write("    </div>\n");
