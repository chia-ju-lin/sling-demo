...
public final class node__002d__move__002e__jsp extends org.apache.sling.scripting.jsp.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      // /libs/composum/nodes/console/dialogs/node-move.jsp(6,0) name = id type = java.lang.String reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_cpn_component_0.setId("browser");
      // /libs/composum/nodes/console/dialogs/node-move.jsp(6,0) name = type type = java.lang.String reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_cpn_component_0.setType("com.composum.sling.nodes.browser.Browser");
      // /libs/composum/nodes/console/dialogs/node-move.jsp(6,0) name = scope type = java.lang.String reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      if (_jspx_eval_cpn_component_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          out.write("\n");
          out.write("    <div id=\"node-move-dialog\" class=\"dialog modal fade\" role=\"dialog\" aria-hidden=\"true\">\n");
          ...
          out.write("                        <h4 class=\"modal-title\">Move Node</h4>\n");
          out.write("                    </div>\n");
          ...
          out.write("                            <label class=\"control-label\">Node to move <span>(path)</span></label>\n");
          out.write("                            <div class=\"path input-group widget path-widget\" data-rules=\"mandatory\">\n");
          out.write("                                <input name=\"target-node\" class=\"form-control\" type=\"text\"/>\n");
          ...
          out.write("                        </div>\n");
          out.write("                        <div class=\"form-group\">\n");
          out.write("                            <label class=\"control-label\">Target Path <span>(new parent path)</span></label>\n");
          out.write("                            <div class=\"path input-group widget path-widget\" data-rules=\"mandatory\">\n");
          ...
          out.write("                                    <input name=\"name\" class=\"form-control widget text-field-widget\" type=\"text\"\n");
          out.write("                                           placeholder=\"enter node name\" autofocus>\n");
          out.write("                                </div>\n");
          out.write("                            </div>\n");
          out.write("                            <div class=\"col-xs-4\">\n");
          out.write("                                <div class=\"form-group before\">\n");
          out.write("                                    <label class=\"control-label\">Order Before &nbsp; &nbsp; &nbsp; or at ...</label>\n");
          out.write("                                    <input name=\"before\" class=\"form-control widget text-field-widget\" type=\"text\"\n");
          out.write("                                           placeholder=\"node name\" autofocus>\n");
          out.write("                                </div>\n");
          out.write("                            </div>\n");
          out.write("                            <div class=\"col-xs-2\">\n");
          out.write("                                <div class=\"form-group index\">\n");
          out.write("                                    <label class=\"control-label\">Position</label>\n");
          out.write("                                    <div class=\"index input-group widget number-field-widget\" data-options=\"-1\">\n");
          out.write("                                        <input name=\"index\" type=\"text\" class=\"form-control\"/>\n");
          out.write("                                        <span class=\"input-group-addon spinner\"><span\n");
          out.write("                                                class=\"decrement fa fa-minus\" title=\"decrement\"></span><span\n");
          out.write("                                                class=\"increment fa fa-plus\" title=\"increment\"></span></span>\n");
          out.write("                                    </div>\n");
          out.write("                                </div>\n");
          out.write("                            </div>\n");
          out.write("                        </div>\n");
          ...
          out.write("                        <button type=\"submit\" class=\"btn btn-primary move\">Move</button>\n");
          out.write("                    </div>\n");
          out.write("                </form>\n");
          out.write("            </div>\n");
          out.write("        </div>\n");
