...
public final class query__002e__jsp extends org.apache.sling.scripting.jsp.jasper.runtime.HttpJspBase
  ...
  private org.apache.sling.scripting.jsp.jasper.runtime.TagHandlerPool _jspx_tagPool_cpn_form_role_method_classes_action;
  ...
  public void _jspInit() {
    ...
    _jspx_tagPool_cpn_form_role_method_classes_action = org.apache.sling.scripting.jsp.jasper.runtime.TagHandlerPool.getTagHandlerPool(getServletConfig());
  ...
  public void _jspDestroy() {
    ...
    _jspx_tagPool_cpn_form_role_method_classes_action.release();
  }
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      if (_jspx_meth_cpn_form_0(_jspx_page_context))
        return;
      out.write("\n");
      out.write("            <div class=\"query-export\">\n");
      out.write("                <button class=\"fa fa-download btn btn-default\" data-toggle=\"dropdown\"\n");
      out.write("                        title=\"Export Query Result\"><span class=\"caret\"></span></button>\n");
      out.write("                <ul class=\"export-menu dropdown-menu\" aria-labelledby=\"query-export\" role=\"menu\">\n");
      out.write("                </ul>\n");
      out.write("            </div>\n");
      out.write("        </div>\n");
      ...
      out.write("            </div>\n");
      out.write("            <div class=\"input-group template-path\">\n");
      out.write("                <span class=\"key input-group-addon\"></span>\n");
      out.write("                <input class=\"value form-control\" type=\"text\"/>\n");
      out.write("                <span class=\"path-select input-group-addon\">...</span>\n");
      out.write("            </div>\n");
      out.write("            <div class=\"form-inline\">\n");
      out.write("            </div>\n");
      out.write("        </div>\n");
      out.write("    </div>\n");
      out.write("    <div class=\"popover-hook\"></div>\n");
  ...
  private boolean _jspx_meth_cpn_form_0(PageContext _jspx_page_context)
    ...
    //  cpn:form
    com.composum.sling.cpnl.FormTag _jspx_th_cpn_form_0 = (com.composum.sling.cpnl.FormTag) _jspx_tagPool_cpn_form_role_method_classes_action.get(com.composum.sling.cpnl.FormTag.class);
    _jspx_th_cpn_form_0.setPageContext(_jspx_page_context);
    _jspx_th_cpn_form_0.setParent(null);
    // /libs/composum/nodes/browser/query.jsp(9,12) name = classes type = java.lang.String reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_cpn_form_0.setClasses("query-input-form");
    // /libs/composum/nodes/browser/query.jsp(9,12) name = role type = java.lang.String reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_cpn_form_0.setRole("search");
    // /libs/composum/nodes/browser/query.jsp(9,12) name = action type = java.lang.String reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_cpn_form_0.setAction("/bin/cpm/nodes/node.query.html");
    // /libs/composum/nodes/browser/query.jsp(9,12) name = method type = java.lang.String reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    ...
    if (_jspx_eval_cpn_form_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      ...
      do {
        ...
        out.write("                    <span class=\"templates fa fa-clipboard input-group-addon btn btn-default\"\n");
        out.write("                          title=\"Query Templates\"></span>\n");
        out.write("                    <span class=\"history fa fa-history input-group-addon btn btn-default\" title=\"Query History\"></span>\n");
        ...
        out.write("                    <span class=\"filter fa fa-filter input-group-addon btn btn-default\"\n");
        out.write("                          title=\"Tree Filter ON/OFF\"></span>\n");
        out.write("                </div>\n");
        out.write("            ");
    ...
    if (_jspx_th_cpn_form_0.doEndTag() == javax.servlet.jsp.tagext.Tag.SKIP_PAGE) {
      _jspx_tagPool_cpn_form_role_method_classes_action.reuse(_jspx_th_cpn_form_0);
      return true;
    }
    _jspx_tagPool_cpn_form_role_method_classes_action.reuse(_jspx_th_cpn_form_0);
    return false;
